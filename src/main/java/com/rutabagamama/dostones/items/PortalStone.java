...
public class PortalStone extends ItemBase {

	public PortalStone(String name) {
		super(name);
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		if(player.dimension == -1) {
			...
			BlockPos chunkCoords = worldIn.getSpawnPoint();
			...
			if(worldIn.isRemote) {
				...
				welcomeMessage.appendText(", welcome back to the overworld!");
				...
				playerList.transferPlayerToDimension((EntityPlayerMP) player, 0, new Teleporter((WorldServer) player.getEntityWorld()));
			...
			if (worldIn.isRemote) {
				...
				errorMessage.appendText(", Portal Stone is for getting from nether to overworld, you can't get there from here.");
